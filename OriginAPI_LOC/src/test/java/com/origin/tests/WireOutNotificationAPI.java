...
public class WireOutNotificationAPI extends ExtentReportListener{ 
	...
	@Test
	public void wireoutNotification (HashMap<String, String> requestMap,XSSFSheet apiSheet,XSSFSheet requestSheet,XSSFSheet processSheet) throws IOException {

		System.out.println("----------------------------------------inside wireout notification------------------------------------------------");
		...
		System.out.println("Wireout payload ===== "+payload);
		...
		case "POST": 
			...
			.extract()
			.response();
			System.out.println("---------------------------------------- wireout notification response ------------------------------------------------");
			...
			System.out.println("---------------------------------------------end of  wireout notification--------------------------------------------------------");
			break;
		}
	}
